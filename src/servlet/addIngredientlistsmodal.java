 ...
 * @author Roano
 */
@WebServlet(name = "addIngredientlistsmodal", urlPatterns = {"/addIngredientlistsmodal"})
public class addIngredientlistsmodal extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String name=ingredientslistsdao.viewingredientnamemodal(IGcode);
