 ...
 * @author Desmond
 */
@WebServlet(name = "changedelivernumber", urlPatterns = {"/changedelivernumber"})
public class changedelivernumber extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if(ClientOrderdao.changedeliveryreceipt(code, dcode)){
